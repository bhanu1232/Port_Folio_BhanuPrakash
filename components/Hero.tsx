      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-8 items-center w-full">
        <div className="space-y-8 text-center md:text-left">
          <h1 className={`text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight transition-all duration-700 ${loaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'}`}>
            Elias is a <span className="font-extrabold text-purple-400">Web <br /> Designer</span> and <span className="font-extrabold text-purple-400">Front- <br /> End Developer</span>
          </h1>
          <p className={`text-base sm:text-lg text-gray-400 transition-all duration-700 delay-200 ${loaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'}`}>He crafts responsive websites where technologies meet creativity</p>
        ...
        <div className={`relative flex justify-center items-center transition-opacity duration-1000 delay-500 ${loaded ? 'opacity-100' : 'opacity-0'}`}>
            <div className="relative w-full max-w-sm sm:max-w-md mx-auto">
                <img src="https://i.imgur.com/u16ny3U.png" alt="Elias, the developer, in a dark hoodie and cap, looking down." className="w-full object-contain z-10" />
