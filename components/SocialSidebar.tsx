...
const SocialSidebar: React.FC = () => {
  return (
    <aside className="fixed top-0 left-0 h-screen w-16 md:w-20 flex flex-col items-center justify-center space-y-8 z-50 border-r border-gray-700/50">
      <a href="mailto:cbhanuprakash1212@gmail.com" aria-label="Email" className="text-gray-400 hover:text-purple-400 transition-colors">
        <MailIcon className="h-6 w-6" />
      </a>
      <a href="https://www.github.com/bhanu1232" aria-label="Github" className="text-gray-400 hover:text-purple-400 transition-colors">
